...
export async function GET(req: NextRequest) {
  ...
  return NextResponse.json({
    game: {
      ...
      homeTeam: game.homeTeam ? { name: game.homeTeam.name, flagUrl: game.homeTeam.flagUrl } : { name: 'TBD', flagUrl: 'https://flagcdn.com/w320/un.png' },
      awayTeam: game.awayTeam ? { name: game.awayTeam.name, flagUrl: game.awayTeam.flagUrl } : { name: 'TBD', flagUrl: 'https://flagcdn.com/w320/un.png' },

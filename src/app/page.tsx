  ...
  const gamesForClient = matchCenterGames
    ...
    .map(g => {
      ...
      return {
        ...
        homeTeam: g.homeTeam ? { name: g.homeTeam.name, flagUrl: g.homeTeam.flagUrl } : { name: 'TBD', flagUrl: 'https://flagcdn.com/w320/un.png' },
        awayTeam: g.awayTeam ? { name: g.awayTeam.name, flagUrl: g.awayTeam.flagUrl } : { name: 'TBD', flagUrl: 'https://flagcdn.com/w320/un.png' },
